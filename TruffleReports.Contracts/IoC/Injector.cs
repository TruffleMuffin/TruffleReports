...
namespace TruffleReports.Contracts.IoC
{
    /// <summary>
    ...
    public class Injector
    {
        ...
        public static IResolver Resolver
        {
            get
            {
                if (resolver == null) throw new NotImplementedException("A resolve must be specified for TruffleReports.Contracts.IoC.Injector.");
